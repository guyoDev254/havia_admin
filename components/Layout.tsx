...
const navigationSections: NavigationSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Mentees', href: '/mentorships/mentees', icon: GraduationCap, permission: Permission.REVIEW_MENTEE_APPLICATIONS },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'FAQs', href: '/faqs', icon: HelpCircle, permission: Permission.CREATE_CONTENT },
    ],
    defaultOpen: true,
  },
  {
