        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">{eventDetail.title}</h1>
                <p className="mt-1 text-sm text-gray-500">{eventDetail.type}</p>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white shadow rounded-lg p-6">
                ...
                {editing ? (
                  ...
                  <p className="text-gray-700 whitespace-pre-wrap">{eventDetail.description}</p>
                )}
              </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        {editing ? (
                          ...
                          <p className="text-gray-900">{eventDetail.location}</p>
                        )}
                      </div>
                    </div>
                  )}
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    {editing ? (
                      ...
                      <p className="text-gray-900">{eventDetail.type}</p>
                    )}
                  </div>
              ...
              <div className="bg-white shadow rounded-lg p-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-500">{eventDetail.organizer.email}</p>
                </div>
              </div>
              ...
              {eventDetail.club && (
                <div className="bg-white shadow rounded-lg p-6">
                  <h2 className="text-lg font-semibold mb-4">Club</h2>
                  <p className="text-gray-900">{eventDetail.club.name}</p>
                </div>
              )}
