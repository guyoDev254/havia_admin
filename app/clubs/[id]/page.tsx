                ...
                <>
                  {editing ? (
                    <>
                      <button
                        onClick={handleSave}
                        className="flex items-center gap-2 px-4 py-2 bg-primary-600 dark:bg-primary-500 text-white rounded-md hover:bg-primary-700 dark:hover:bg-primary-600"
                      >
                    ...
                    <>
                      {(canManage || hasPermission(Permission.SCHEDULE_EVENTS)) && (
                        <button
                          ...
                          className="flex items-center gap-2 px-4 py-2 bg-purple-600 dark:bg-purple-500 text-white rounded-md hover:bg-purple-700 dark:hover:bg-purple-600"
                        >
                            ...
                            <td className="px-4 py-4 whitespace-nowrap">
                              <div className="flex items-center">
                                {member.profileImage ? (
                                  ...
                                  <div className="h-10 w-10 rounded-full bg-blue-500 dark:bg-blue-600 flex items-center justify-center text-white text-sm font-medium">
                                    {member.firstName?.[0] || ''}
                                    {member.lastName?.[0] || ''}
                                  </div>
                                )}
